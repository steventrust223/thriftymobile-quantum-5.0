...
const TM_DEFAULT_SETTINGS = [
  ...
  ['CRM_ENABLED', 'FALSE', 'Enable CRM integration (TRUE/FALSE)', 'CRM', ''],
  ['CRM_PROVIDER', 'none', 'CRM provider (smsit, onehash, ohmylead, webhook, none)', 'CRM', ''],
  ['CRM_API_KEY', '', 'API key for CRM provider', 'CRM', ''],
  ['CRM_API_SECRET', '', 'API secret for CRM provider (if required)', 'CRM', ''],
  ['CRM_WEBHOOK_URL', '', 'Webhook URL for CRM integration', 'CRM', ''],

  // SMS Integration Settings
  ['SMS_ENABLED', 'FALSE', 'Enable SMS integration (TRUE/FALSE)', 'SMS', ''],
  ['SMS_PROVIDER', 'none', 'SMS provider (smsit, twilio, webhook, none)', 'SMS', ''],
  ['SMS_API_KEY', '', 'API key for SMS provider', 'SMS', ''],
  ['SMS_API_SECRET', '', 'API secret for SMS provider (if required)', 'SMS', ''],
  ['SMS_FROM_NUMBER', '', 'Phone number to send SMS from', 'SMS', ''],
  ['SMS_WEBHOOK_URL', '', 'Webhook URL for SMS integration', 'SMS', ''],

  // E-Signature Integration Settings
  ['ESIGN_ENABLED', 'FALSE', 'Enable e-signature integration (TRUE/FALSE)', 'E-Signature', ''],
...
const TM_VERSION = {
  ...
  FEATURES: [
    'Multi-platform device import (FB, CL, OfferUp, eBay)',
    'Automated device grading engine',
    'Buyback partner price matching with fuzzy search',
    'MAO (Maximum Allowable Offer) calculation',
    'Deal classification and scoring',
    'Hot seller detection',
    'CRM integration (SMS-iT, OneHash, OhmyLead, Webhook)',
