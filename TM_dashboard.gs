...
function TM_showDashboardSidebar() {
  // For now, just update the dashboard and show a toast
  TM_updateDashboardAnalytics();
  TM_showToast('Dashboard updated! Check DASHBOARD_ANALYTICS sheet.', 'Dashboard', 5);

  // You could create a separate HTML sidebar for this
  // For now, redirect to showing summary
  TM_showDailySummaryDialog();
}
